...
#+begin_src
usage: AppImage Packer [-h] -e EXECUTABLE_PATH [-p PACKAGING_TOOL] [-od OUTPUT_DIRECTORY] [-of OUTPUT_FILE] [--arch ARCH] [--only-appdir]
                       [--keep-appdir]
...
options:
  ...
  -of, --output-file OUTPUT_FILE
                        The output AppImage file directory.
  --arch ARCH           ARCH of an AppImage.
